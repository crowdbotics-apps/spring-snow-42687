"""
Django settings for spring_snow_42687 project.
...
ROOT_URLCONF = 'spring_snow_42687.urls'
...
WSGI_APPLICATION = 'spring_snow_42687.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_snow_42687 API",
    "DESCRIPTION": "API documentation for spring_snow_42687 App",
    "VERSION": "v1",
}
